...
// 名前空間は本家の GearMenu から変更している。参照 DLL（COM3D2.ExternalPreset.Managed 等）が
// 同じ okiba 由来の GearMenu.Buttons を内包しており、型が衝突する（CS0436）ため
namespace COM3D2.ModItemExplorer.Plugin.GearMenu
{
    /// <summary>
    /// 歯車メニューへのアイコン登録
    /// </summary>
